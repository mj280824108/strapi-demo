...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-YUUZdkHs.js"));
        return component;
      }
    });
    app.registerPlugin({
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-iCC7KoGn.js"));
        return component;
      },
      permissions: PERMISSIONS.main
    });
...
//# sourceMappingURL=index-SkRqZn8M.js.map
